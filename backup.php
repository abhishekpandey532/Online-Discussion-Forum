...
<h1 align="left"><b>Subject:<br/></b></h1><Label rows="2" name="subject" cols="100" id="subject" ><?php  echo $sub; ?></textarea><br/><br/></h2>
...
-->
    ...
    <div id="div1-response">
    	<div id="div1">
    		<ul>
<?php
      $co="SELECT `user_id`, `date`, `content`,`id` FROM `comments` WHERE `postid` = $pid";
